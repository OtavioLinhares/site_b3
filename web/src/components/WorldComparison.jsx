                ...
                <div style={{
                    ...
                    <div className="section-desc" style={{
                        ...
                        <p style={{ marginBottom: 'var(--spacing-4)' }}>
                            ...
                            Enquanto a rentabilidade das empresas brasileiras segue a média mundial, <strong style={{ color: 'var(--color-text-primary)' }}>o Brasil se destaca como um dos mercados mais baratos</strong> pelo múltiplo P/L, indicando desconto.
